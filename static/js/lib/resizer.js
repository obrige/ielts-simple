...
var Resizer = function () {
    ...
    const enableTextSelection = (availableToSelect = true) => {
        document.querySelector(TEST_PART_SELECTOR).style.userSelect = availableToSelect ? 'auto' : 'none';
    }

    Resizer.prototype.onDown = function (e) {
        if (e.target.hasAttribute('data-rz-handle')) {
